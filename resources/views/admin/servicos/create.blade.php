...
<html>
    ...
    <aside class="right-side">
        <section class="content-header">
            <h1>
                <i class="fa fa-briefcase"></i> Adicionar Servi&ccedil;os
            </h1>
        </section>
        <section class="content">
            <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
                ...
                <div class="box box-warning">
                    <div class="box-body">
                        {!! Form::open(["route" => "admin.servicos.store", "role" => "form"]) !!}
                        <!--<form role="form" method="POST">-->
                            ...
                            <div class="form-group">
                                ...
                                {{--</button>--}}
                                {!! Form::submit("Salvar", ["class" => "btn btn-success", "id" => "sendEmail"]) !!}
                            </div>
                        <!--</form>-->{!! Form::close() !!}
                    </div>
                </div>
