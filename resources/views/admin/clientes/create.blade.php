...
<title>Dashboard | Add Cliente</title>
                    ...
                    {{--<form role="form" method="POST" id="submitPostForm" enctype="multipart/form-data">--}}
                        ...
                        <div class="slideHeader">
                            <div class="form-group">
                                ...
                                {!! Form::text("nome", null, ["class" => "form-control slideTitle", "placeholder" => "Entre com o nome do cliente"]) !!}
                                {{--<input type="text" class="form-control slideTitle" name="sTitle[]" placeholder="Entre com nome do Cliente" value="">--}}
                                {{--<p class="error-msg label label-danger slideTitleError hide">--}}
                                    {{--<i class="fa fa-times"></i> Título comprimento mínimo deve ser de 20 caracteres</p>--}}
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="name">Site do Cliente (URL)</label>
                                {!! Form::text("site", null, ["class" => "form-control slideTitle", "placeholder" =>"Entre com site do Cliente"]) !!}
                                {{--<input type="text" class="form-control slideTitle" name="sTitle[]" placeholder="Entre com nome do Cliente" value="">--}}
                                <p class="error-msg label label-danger slideTitleError hide">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="fileupload fileupload-new qpLarge" data-provides="fileupload">
                                                ...
                                                <span class="btn btn-white btn-file">
                                                    ...
                                                    {{--<input type="file" class="default" accept="image/jpg,image/png,image/jpeg,image/gif"/>--}}
                                                    {!! Form::file("imagem", null, ["class" => "default", "accept" => "image/jpg,image/png,image/jpeg,image/gif"]) !!}

                                                </span>
                                                <p class="error-msg label label-danger imgCardAlert sFileError hide"><i class="fa fa-times-circle"></i> Dimens&atilde;o Inv&aacute;lido ou vazio </p><p class="imgDimensions">1000x1000</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
